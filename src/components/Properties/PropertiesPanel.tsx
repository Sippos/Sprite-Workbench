import { useProject, FRAME_SIZES, SINGLE_PNG_PRESETS } from "../../store/ProjectContext";
    ...
    <aside className="ide-sidebar ide-sidebar-right">
      ...
      <div className="properties-content">
        ...
        <section className="prop-section">
          ...
          <p className="info" style={{fontSize: "11px", marginBottom: "8px"}}>These customize the single PNG export without altering the spritesheet frame.</p>
          <label>Preset
        ...
        <section className="prop-section accordion-section">
          <details>
            <summary><h3>Cleanup Tools</h3></summary>
